  ...
  if (showGuide) {
    return (
      <div className='text-center'>
        ...
        <br /><br />
        <span className="text-3xl">Las clases comenzarán el domingo 6 de agosto en LCP</span>
        <br /><br />
        <span className="text-3xl">Para más información contactar con Grismeda Ortiz (04142142517)</span>
        <br /><br />
        <a
